...
Sub Activity_Create(FirstTime As Boolean)
	...
	CLV.Clear
	imgMap.Clear
	Core.ExecuteUrlGet(Main.API&"homestay", "loadHomestay", Me)
End Sub
				...
				Try
					...
					If data.Size-1 > 0 Then
						...
						For i = 0 To data.Size-1
							Dim rg As Map
							rg = data.Get(i)
							CLV.Add(CreateItem(rg.Get("id_rumah_gadang"), rg.Get("name"), rg.Get("gallery")), "")
...
Private Sub PanelListItem_Click
	...
	Starter.selectedObj.Put("id_rumah_gadang", a.GetView(0).GetView(0).Text)
