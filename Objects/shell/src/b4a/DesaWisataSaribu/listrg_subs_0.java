...
if (RapidSub.canDelegate("activity_create")) { return b4a.DesaWisataSaribu.listrg.remoteMe.runUserSub(false, "listrg","activity_create", _firsttime);}
...
listrg.mostCurrent._mediamanager.runClassMethod (b4a.DesaWisataSaribu.simplemediamanager.class, "_initialize" /*RemoteObject*/ ,listrg.mostCurrent.activityBA);
...
listrg.mostCurrent._imgmap.runVoidMethod ("Clear");
 BA.debugLineNum = 50;BA.debugLine="Core.ExecuteUrlGet(Main.API&\"homestay\", \"loadHome";
Debug.ShouldStop(131072);
listrg.mostCurrent._core.runVoidMethod ("_executeurlget" /*RemoteObject*/ ,listrg.mostCurrent.activityBA,(Object)(RemoteObject.concat(listrg.mostCurrent._main._api /*RemoteObject*/ ,RemoteObject.createImmutable("homestay"))),(Object)(BA.ObjectToString("loadHomestay")),(Object)(listrg.getObject()));
...
if (RapidSub.canDelegate("activity_pause")) { return b4a.DesaWisataSaribu.listrg.remoteMe.runUserSub(false, "listrg","activity_pause", _userclosed);}
...
if (RapidSub.canDelegate("activity_resume")) { return b4a.DesaWisataSaribu.listrg.remoteMe.runUserSub(false, "listrg","activity_resume");}
...
listrg.mostCurrent.__c.runVoidMethod ("LogImpl","22162689",RemoteObject.createImmutable("ListRG loaded"),0);
...
if (RapidSub.canDelegate("btnback_click")) { return b4a.DesaWisataSaribu.listrg.remoteMe.runUserSub(false, "listrg","btnback_click");}
...
listrg.mostCurrent.__c.runVoidMethod ("LogImpl","22293761",RemoteObject.createImmutable("Going back to previous activity"),0);
...
Debug.ShouldStop(1073741824);
listrg.mostCurrent.__c.runVoidMethod ("LogImpl","22752513",RemoteObject.createImmutable("Redirect to Cart Activity"),0);
...
if (RapidSub.canDelegate("btnrefresh_click")) { return b4a.DesaWisataSaribu.listrg.remoteMe.runUserSub(false, "listrg","btnrefresh_click");}
 BA.debugLineNum = 126;BA.debugLine="Private Sub btnRefresh_Click";
Debug.ShouldStop(536870912);
 BA.debugLineNum = 127;BA.debugLine="Log(\"Refreshing ListRG...\")";
Debug.ShouldStop(1073741824);
listrg.mostCurrent.__c.runVoidMethod ("LogImpl","22555905",RemoteObject.createImmutable("Refreshing ListRG..."),0);
...
Debug.ShouldStop(1);
listrg.mostCurrent._loadrefresh.runMethod(true,"setVisible",listrg.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 130;BA.debugLine="Core.ExecuteUrlGet(Main.API&\"homestay\", \"loadHome";
Debug.ShouldStop(2);
listrg.mostCurrent._core.runVoidMethod ("_executeurlget" /*RemoteObject*/ ,listrg.mostCurrent.activityBA,(Object)(RemoteObject.concat(listrg.mostCurrent._main._api /*RemoteObject*/ ,RemoteObject.createImmutable("homestay"))),(Object)(BA.ObjectToString("loadHomestay")),(Object)(listrg.getObject()));
...
if (RapidSub.canDelegate("clv_itemclick")) { return b4a.DesaWisataSaribu.listrg.remoteMe.runUserSub(false, "listrg","clv_itemclick", _index, _value);}
...
if (RapidSub.canDelegate("createitem")) { return b4a.DesaWisataSaribu.listrg.remoteMe.runUserSub(false, "listrg","createitem", _id, _name, _img);}
...
if (RapidSub.canDelegate("downloadimg")) { return b4a.DesaWisataSaribu.listrg.remoteMe.runUserSub(false, "listrg","downloadimg", _imagemap, _readytodownload, _extra);}
int _i = 0;
...
Debug.ShouldStop(256);
listrg.mostCurrent.__c.runVoidMethod ("LogImpl","22621444",RemoteObject.concat(RemoteObject.createImmutable("Getting "),_imagemap.runMethod(false,"GetValueAt",(Object)(BA.numberCast(int.class, _i))),RemoteObject.createImmutable("@"),_imagemap.runMethod(false,"GetKeyAt",(Object)(BA.numberCast(int.class, _i)))),0);
...
listrg.mostCurrent._mediamanager = RemoteObject.createNew ("b4a.DesaWisataSaribu.simplemediamanager");
...
if (RapidSub.canDelegate("jobdone")) { return b4a.DesaWisataSaribu.listrg.remoteMe.runUserSub(false, "listrg","jobdone", _job);}
...
Debug.ShouldStop(2097152);
listrg.mostCurrent.__c.runVoidMethod ("LogImpl","22490369",RemoteObject.concat(RemoteObject.createImmutable("JobName = "),_job.getField(true,"_jobname" /*RemoteObject*/ ),RemoteObject.createImmutable(", Success = "),_job.getField(true,"_success" /*RemoteObject*/ )),0);
...
Debug.ShouldStop(536870912);
switch (BA.switchObjectToInt(_job.getField(true,"_jobname" /*RemoteObject*/ ),BA.ObjectToString("loadHomestay"))) {
case 0: {
...
Debug.ShouldStop(8388608);
listrg.mostCurrent.__c.runVoidMethod ("LogImpl","22490403",BA.ObjectToString(listrg.mostCurrent.__c.runMethod(false,"LastException",listrg.mostCurrent.activityBA)),0);
 };
 break; }
}
;
...
if (RapidSub.canDelegate("panellistitem_click")) { return b4a.DesaWisataSaribu.listrg.remoteMe.runUserSub(false, "listrg","panellistitem_click");}
...
listrg.mostCurrent._starter._selectedobj /*RemoteObject*/ .runVoidMethod ("Initialize");
 BA.debugLineNum = 152;BA.debugLine="Starter.selectedObj.Put(\"id_rumah_gadang\", a.GetV";
Debug.ShouldStop(8388608);
listrg.mostCurrent._starter._selectedobj /*RemoteObject*/ .runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("id_rumah_gadang"))),(Object)((_a.runMethod(false,"GetView",(Object)(BA.numberCast(int.class, 0))).runMethod(false,"GetView",(Object)(BA.numberCast(int.class, 0))).runMethod(true,"getText"))));
...
Debug.ShouldStop(67108864);
listrg.mostCurrent.__c.runVoidMethod ("LogImpl","22686987",RemoteObject.createImmutable("Redirect to DetailRG Activity"),0);
