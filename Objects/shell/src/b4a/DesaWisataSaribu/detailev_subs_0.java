...
try {
		Debug.PushSubsStack("Activity_Create (detailev) ","detailev",4,detailev.mostCurrent.activityBA,detailev.mostCurrent,24);
if (RapidSub.canDelegate("activity_create")) { return b4a.DesaWisataSaribu.detailev.remoteMe.runUserSub(false, "detailev","activity_create", _firsttime);}
...
try {
		Debug.PushSubsStack("Activity_Pause (detailev) ","detailev",4,detailev.mostCurrent.activityBA,detailev.mostCurrent,42);
if (RapidSub.canDelegate("activity_pause")) { return b4a.DesaWisataSaribu.detailev.remoteMe.runUserSub(false, "detailev","activity_pause", _userclosed);}
...
try {
		Debug.PushSubsStack("Activity_Resume (detailev) ","detailev",4,detailev.mostCurrent.activityBA,detailev.mostCurrent,38);
if (RapidSub.canDelegate("activity_resume")) { return b4a.DesaWisataSaribu.detailev.remoteMe.runUserSub(false, "detailev","activity_resume");}
 BA.debugLineNum = 38;BA.debugLine="Sub Activity_Resume";
Debug.ShouldStop(32);
 BA.debugLineNum = 39;BA.debugLine="Log(\"DetailEV loaded\")";
Debug.ShouldStop(64);
detailev.mostCurrent.__c.runVoidMethod ("LogImpl","23014657",RemoteObject.createImmutable("DetailEV loaded"),0);
...
try {
		Debug.PushSubsStack("BtnBack_Click (detailev) ","detailev",4,detailev.mostCurrent.activityBA,detailev.mostCurrent,47);
if (RapidSub.canDelegate("btnback_click")) { return b4a.DesaWisataSaribu.detailev.remoteMe.runUserSub(false, "detailev","btnback_click");}
...
detailev.mostCurrent.__c.runVoidMethod ("LogImpl","23145729",RemoteObject.createImmutable("Going back to previous activity"),0);
