...
try {
		Debug.PushSubsStack("BtnBack_Click (homeuser) ","homeuser",6,homeuser.mostCurrent.activityBA,homeuser.mostCurrent,271);
if (RapidSub.canDelegate("btnback_click")) { return b4a.DesaWisataSaribu.homeuser.remoteMe.runUserSub(false, "homeuser","btnback_click");}
 BA.debugLineNum = 271;BA.debugLine="Private Sub BtnBack_Click";
Debug.ShouldStop(16384);
 BA.debugLineNum = 272;BA.debugLine="Activity.Finish ' Kembali ke activity sebelumnya";
...
try {
		Debug.PushSubsStack("btnCart_Click (homeuser) ","homeuser",6,homeuser.mostCurrent.activityBA,homeuser.mostCurrent,265);
if (RapidSub.canDelegate("btncart_click")) { return b4a.DesaWisataSaribu.homeuser.remoteMe.runUserSub(false, "homeuser","btncart_click");}
 BA.debugLineNum = 265;BA.debugLine="Private Sub btnCart_Click";
Debug.ShouldStop(256);
 BA.debugLineNum = 266;BA.debugLine="Log(\"Redirect to Cart Activity\")";
Debug.ShouldStop(512);
homeuser.mostCurrent.__c.runVoidMethod ("LogImpl","242270721",RemoteObject.createImmutable("Redirect to Cart Activity"),0);
 BA.debugLineNum = 267;BA.debugLine="StartActivity(Cart)";
Debug.ShouldStop(1024);
...
try {
		Debug.PushSubsStack("BtnGemma_Click (homeuser) ","homeuser",6,homeuser.mostCurrent.activityBA,homeuser.mostCurrent,259);
if (RapidSub.canDelegate("btngemma_click")) { return b4a.DesaWisataSaribu.homeuser.remoteMe.runUserSub(false, "homeuser","btngemma_click");}
 BA.debugLineNum = 259;BA.debugLine="Private Sub BtnGemma_Click";
Debug.ShouldStop(4);
 BA.debugLineNum = 260;BA.debugLine="Log(\"Redirect to Gemma Activity\")";
Debug.ShouldStop(8);
homeuser.mostCurrent.__c.runVoidMethod ("LogImpl","25111809",RemoteObject.createImmutable("Redirect to Gemma Activity"),0);
 BA.debugLineNum = 261;BA.debugLine="StartActivity(Gemma)";
Debug.ShouldStop(16);
...
//C
this.state = 6;
 BA.debugLineNum = 250;BA.debugLine="Log(\"Logout cancelled.\")";
...
try {
		Debug.PushSubsStack("BtnPackage_Click (homeuser) ","homeuser",6,homeuser.mostCurrent.activityBA,homeuser.mostCurrent,254);
if (RapidSub.canDelegate("btnpackage_click")) { return b4a.DesaWisataSaribu.homeuser.remoteMe.runUserSub(false, "homeuser","btnpackage_click");}
 BA.debugLineNum = 254;BA.debugLine="Private Sub BtnPackage_Click";
Debug.ShouldStop(536870912);
 BA.debugLineNum = 255;BA.debugLine="Log(\"Redirect to List Package\")";
Debug.ShouldStop(1073741824);
homeuser.mostCurrent.__c.runVoidMethod ("LogImpl","25046273",RemoteObject.createImmutable("Redirect to List Package"),0);
 BA.debugLineNum = 256;BA.debugLine="StartActivity(ListPackage)";
Debug.ShouldStop(-2147483648);
