...
__ref.runClassMethod (b4a.DesaWisataSaribu.roundslider.class, "_createthumb" /*RemoteObject*/ );};
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSaribu.roundslider.class, "_draw" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSaribu.roundslider.class, "_base_resize" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight"))));
...
try {
		Debug.PushSubsStack("getValue (roundslider) ","roundslider",48,__ref.getField(false, "ba"),__ref,182);
...
try {
		Debug.PushSubsStack("SetRange (roundslider) ","roundslider",48,__ref.getField(false, "ba"),__ref,176);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSaribu.roundslider.class, "_setvalue" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_mvalue" /*RemoteObject*/ )));
