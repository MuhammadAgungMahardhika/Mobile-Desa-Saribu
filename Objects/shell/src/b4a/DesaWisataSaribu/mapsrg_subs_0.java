...
Debug.ShouldStop(16384);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","23473409",RemoteObject.createImmutable("MapsRG Loaded"),0);
...
Debug.ShouldStop(8);
mapsrg.mostCurrent.__c.runVoidMethod ("LogImpl","23604481",RemoteObject.createImmutable("Going back to previous activity"),0);
...
Debug.ShouldStop(2097152);
mapsrg.mostCurrent.__c.runVoidMethod ("LogImpl","24456449",RemoteObject.createImmutable("Redirect to Cart Activity"),0);
...
mapsrg.mostCurrent.__c.runVoidMethod ("LogImpl","24194305",RemoteObject.createImmutable("Redirect to ListRG activity"),0);
...
Debug.ShouldStop(512);
mapsrg.mostCurrent.__c.runVoidMethod ("LogImpl","23866625",RemoteObject.createImmutable("Pan to Rumah Gadang"),0);
...
Debug.ShouldStop(4);
mapsrg.mostCurrent.__c.runVoidMethod ("LogImpl","23801089",RemoteObject.createImmutable("Panning to user location"),0);
...
Debug.ShouldStop(8);
mapsrg.mostCurrent.__c.runVoidMethod ("LogImpl","23997702",RemoteObject.concat(RemoteObject.createImmutable("Searching '"),mapsrg._namerg,RemoteObject.createImmutable("' on maps")),0);
...
Debug.ShouldStop(1024);
mapsrg.mostCurrent.__c.runVoidMethod ("LogImpl","24063233",RemoteObject.concat(RemoteObject.createImmutable("JobName = "),_job.getField(true,"_jobname" /*RemoteObject*/ ),RemoteObject.createImmutable(", Success = "),_job.getField(true,"_success" /*RemoteObject*/ )),0);
...
Debug.ShouldStop(2);
mapsrg.mostCurrent.__c.runVoidMethod ("LogImpl","24063256",BA.ObjectToString(mapsrg.mostCurrent.__c.runMethod(false,"LastException",mapsrg.mostCurrent.activityBA)),0);
 };
 break; }
}
;
...
Debug.ShouldStop(16384);
mapsrg.mostCurrent.__c.runVoidMethod ("LogImpl","24390928",RemoteObject.concat(RemoteObject.createImmutable("Searching RG with category: "),_value),0);
...
Debug.ShouldStop(16777216);
mapsrg.mostCurrent.__c.runVoidMethod ("LogImpl","24325393",RemoteObject.concat(RemoteObject.createImmutable("Searching RG with facility: "),_value),0);
...
Debug.ShouldStop(2);
mapsrg.mostCurrent.__c.runVoidMethod ("LogImpl","24259857",RemoteObject.concat(RemoteObject.createImmutable("Searching RG with "),_value,RemoteObject.createImmutable(" rating")),0);
...
Debug.ShouldStop(512);
mapsrg.mostCurrent.__c.runVoidMethod ("LogImpl","23670017",RemoteObject.createImmutable("Update user position on Maps Rumah Gadang"),0);
 BA.debugLineNum = 107;BA.debugLine="Log(\"Lat: \"&Starter.lat&\"; Long: \"&Starter.lng)";
Debug.ShouldStop(1024);
mapsrg.mostCurrent.__c.runVoidMethod ("LogImpl","23670018",RemoteObject.concat(RemoteObject.createImmutable("Lat: "),mapsrg.mostCurrent._starter._lat /*RemoteObject*/ ,RemoteObject.createImmutable("; Long: "),mapsrg.mostCurrent._starter._lng /*RemoteObject*/ ),0);
...
Debug.ShouldStop(262144);
mapsrg.mostCurrent.__c.runVoidMethod ("LogImpl","23735554",RemoteObject.createImmutable("Webview loaded"),0);
...
Debug.ShouldStop(536870912);
mapsrg.mostCurrent.__c.runVoidMethod ("LogImpl","23735565",RemoteObject.concat(RemoteObject.createImmutable("Webview loading at "),_loading,RemoteObject.createImmutable("% ....")),0);
 };
...
Debug.ShouldStop(256);
mapsrg.mostCurrent.__c.runVoidMethod ("LogImpl","23407873",RemoteObject.createImmutable("WebView Error:"),0);
 BA.debugLineNum = 74;BA.debugLine="Log(\"Error Code: \" & ErrorCode)";
Debug.ShouldStop(512);
mapsrg.mostCurrent.__c.runVoidMethod ("LogImpl","23407874",RemoteObject.concat(RemoteObject.createImmutable("Error Code: "),_errorcode),0);
 BA.debugLineNum = 75;BA.debugLine="Log(\"Description: \" & Description)";
Debug.ShouldStop(1024);
mapsrg.mostCurrent.__c.runVoidMethod ("LogImpl","23407875",RemoteObject.concat(RemoteObject.createImmutable("Description: "),_description),0);
 BA.debugLineNum = 76;BA.debugLine="Log(\"Failing URL: \" & FailingUrl)";
Debug.ShouldStop(2048);
mapsrg.mostCurrent.__c.runVoidMethod ("LogImpl","23407876",RemoteObject.concat(RemoteObject.createImmutable("Failing URL: "),_failingurl),0);
