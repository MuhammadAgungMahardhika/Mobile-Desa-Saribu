...
public boolean isSingleton() {
    ...
    static {
        ...
        remoteMe = RemoteObject.declareNull("b4a.DesaWisataSaribu.b4xcollections");
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("b4xcollections"), "b4a.DesaWisataSaribu.b4xcollections");
        RDebug.INSTANCE.eventTargets.put(new DeviceClass("b4a.DesaWisataSaribu.b4xcollections"), new java.lang.ref.WeakReference<PCBA> (pcBA));
	}
