...
try {
		Debug.PushSubsStack("Activity_Create (mapsev) ","mapsev",8,mapsev.mostCurrent.activityBA,mapsev.mostCurrent,41);
if (RapidSub.canDelegate("activity_create")) { return b4a.DesaWisataSaribu.mapsev.remoteMe.runUserSub(false, "mapsev","activity_create", _firsttime);}
...
mapsev.mostCurrent._dialog.runClassMethod (b4a.DesaWisataSaribu.b4xdialog.class, "_initialize" /*RemoteObject*/ ,mapsev.mostCurrent.activityBA,RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), mapsev.mostCurrent._activity.getObject()));
...
mapsev.mostCurrent._datetemplate.runClassMethod (b4a.DesaWisataSaribu.b4xdatetemplate.class, "_initialize" /*RemoteObject*/ ,mapsev.mostCurrent.activityBA);
...
try {
		Debug.PushSubsStack("Activity_Pause (mapsev) ","mapsev",8,mapsev.mostCurrent.activityBA,mapsev.mostCurrent,99);
if (RapidSub.canDelegate("activity_pause")) { return b4a.DesaWisataSaribu.mapsev.remoteMe.runUserSub(false, "mapsev","activity_pause", _userclosed);}
...
try {
		Debug.PushSubsStack("Activity_Resume (mapsev) ","mapsev",8,mapsev.mostCurrent.activityBA,mapsev.mostCurrent,82);
if (RapidSub.canDelegate("activity_resume")) { b4a.DesaWisataSaribu.mapsev.remoteMe.runUserSub(false, "mapsev","activity_resume"); return;}
...
Debug.ShouldStop(262144);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","85767169",RemoteObject.createImmutable("MapsEV Loaded"),0);
...
try {
		Debug.PushSubsStack("BtnBack_Click (mapsev) ","mapsev",8,mapsev.mostCurrent.activityBA,mapsev.mostCurrent,103);
if (RapidSub.canDelegate("btnback_click")) { return b4a.DesaWisataSaribu.mapsev.remoteMe.runUserSub(false, "mapsev","btnback_click");}
...
Debug.ShouldStop(128);
mapsev.mostCurrent.__c.runVoidMethod ("LogImpl","85898241",RemoteObject.createImmutable("Going back to previous activity"),0);
...
try {
		Debug.PushSubsStack("btnDate_Click (mapsev) ","mapsev",8,mapsev.mostCurrent.activityBA,mapsev.mostCurrent,262);
if (RapidSub.canDelegate("btndate_click")) { b4a.DesaWisataSaribu.mapsev.remoteMe.runUserSub(false, "mapsev","btndate_click"); return;}
...
Debug.ShouldStop(64);
parent.mostCurrent.__c.runVoidMethod ("WaitFor","complete", mapsev.processBA, anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "mapsev", "btndate_click"), parent.mostCurrent._dialog.runClassMethod (b4a.DesaWisataSaribu.b4xdialog.class, "_showtemplate" /*RemoteObject*/ ,(Object)((parent.mostCurrent._datetemplate)),(Object)(RemoteObject.createImmutable((""))),(Object)(RemoteObject.createImmutable((""))),(Object)((RemoteObject.createImmutable("Cancel")))));
this.state = 5;
return;
case 5:
//C
...
Debug.ShouldStop(2048);
_selecteddate = parent.mostCurrent.__c.getField(false,"DateTime").runMethod(true,"Date",(Object)(parent.mostCurrent._datetemplate.runClassMethod (b4a.DesaWisataSaribu.b4xdatetemplate.class, "_getdate" /*RemoteObject*/ )));Debug.locals.put("selectedDate", _selecteddate);
...
Debug.ShouldStop(524288);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","86684686",RemoteObject.concat(RemoteObject.createImmutable("Searching EV with date: "),_selecteddate),0);
...
try {
		Debug.PushSubsStack("btnList_Click (mapsev) ","mapsev",8,mapsev.mostCurrent.activityBA,mapsev.mostCurrent,209);
if (RapidSub.canDelegate("btnlist_click")) { return b4a.DesaWisataSaribu.mapsev.remoteMe.runUserSub(false, "mapsev","btnlist_click");}
...
Debug.ShouldStop(131072);
mapsev.mostCurrent.__c.runVoidMethod ("LogImpl","86488065",RemoteObject.createImmutable("Redirect to ListEV activity"),0);
...
try {
		Debug.PushSubsStack("btnObj_Click (mapsev) ","mapsev",8,mapsev.mostCurrent.activityBA,mapsev.mostCurrent,141);
if (RapidSub.canDelegate("btnobj_click")) { return b4a.DesaWisataSaribu.mapsev.remoteMe.runUserSub(false, "mapsev","btnobj_click");}
...
Debug.ShouldStop(8192);
mapsev.mostCurrent.__c.runVoidMethod ("LogImpl","86160385",RemoteObject.createImmutable("Pan to Event"),0);
...
try {
		Debug.PushSubsStack("btnUserLoc_Click (mapsev) ","mapsev",8,mapsev.mostCurrent.activityBA,mapsev.mostCurrent,134);
if (RapidSub.canDelegate("btnuserloc_click")) { return b4a.DesaWisataSaribu.mapsev.remoteMe.runUserSub(false, "mapsev","btnuserloc_click");}
...
Debug.ShouldStop(64);
mapsev.mostCurrent.__c.runVoidMethod ("LogImpl","86094849",RemoteObject.createImmutable("Panning to user location"),0);
...
try {
		Debug.PushSubsStack("edtSearchEV_EnterPressed (mapsev) ","mapsev",8,mapsev.mostCurrent.activityBA,mapsev.mostCurrent,158);
if (RapidSub.canDelegate("edtsearchev_enterpressed")) { return b4a.DesaWisataSaribu.mapsev.remoteMe.runUserSub(false, "mapsev","edtsearchev_enterpressed");}
...
try {
		Debug.PushSubsStack("FindEV (mapsev) ","mapsev",8,mapsev.mostCurrent.activityBA,mapsev.mostCurrent,163);
if (RapidSub.canDelegate("findev")) { return b4a.DesaWisataSaribu.mapsev.remoteMe.runUserSub(false, "mapsev","findev");}
...
Debug.ShouldStop(256);
mapsev.mostCurrent.__c.runVoidMethod ("LogImpl","86291462",RemoteObject.concat(RemoteObject.createImmutable("Searching '"),mapsev._nameev,RemoteObject.createImmutable("' on maps")),0);
...
mapsev.mostCurrent._btndate = RemoteObject.createNew ("b4a.DesaWisataSaribu.swiftbutton");
 //BA.debugLineNum = 37;BA.debugLine="Private DateTemplate As B4XDateTemplate";
mapsev.mostCurrent._datetemplate = RemoteObject.createNew ("b4a.DesaWisataSaribu.b4xdatetemplate");
 //BA.debugLineNum = 38;BA.debugLine="Private Dialog As B4XDialog";
mapsev.mostCurrent._dialog = RemoteObject.createNew ("b4a.DesaWisataSaribu.b4xdialog");
 //BA.debugLineNum = 39;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _jobdone(RemoteObject _job) throws Exception{
try {
		Debug.PushSubsStack("JobDone (mapsev) ","mapsev",8,mapsev.mostCurrent.activityBA,mapsev.mostCurrent,175);
if (RapidSub.canDelegate("jobdone")) { return b4a.DesaWisataSaribu.mapsev.remoteMe.runUserSub(false, "mapsev","jobdone", _job);}
...
Debug.ShouldStop(32768);
mapsev.mostCurrent.__c.runVoidMethod ("LogImpl","86356993",RemoteObject.concat(RemoteObject.createImmutable("JobName = "),_job.getField(true,"_jobname" /*RemoteObject*/ ),RemoteObject.createImmutable(", Success = "),_job.getField(true,"_success" /*RemoteObject*/ )),0);
...
Debug.ShouldStop(64);
mapsev.mostCurrent.__c.runVoidMethod ("LogImpl","86357016",BA.ObjectToString(mapsev.mostCurrent.__c.runMethod(false,"LastException",mapsev.mostCurrent.activityBA)),0);
 };
 break; }
}
;
...
try {
		Debug.PushSubsStack("spinCategory_ItemClick (mapsev) ","mapsev",8,mapsev.mostCurrent.activityBA,mapsev.mostCurrent,239);
if (RapidSub.canDelegate("spincategory_itemclick")) { return b4a.DesaWisataSaribu.mapsev.remoteMe.runUserSub(false, "mapsev","spincategory_itemclick", _position, _value);}
...
Debug.ShouldStop(-2147483648);
mapsev.mostCurrent.__c.runVoidMethod ("LogImpl","86619153",RemoteObject.concat(RemoteObject.createImmutable("Searching EV with category: "),_value),0);
...
try {
		Debug.PushSubsStack("spinRating_ItemClick (mapsev) ","mapsev",8,mapsev.mostCurrent.activityBA,mapsev.mostCurrent,216);
if (RapidSub.canDelegate("spinrating_itemclick")) { return b4a.DesaWisataSaribu.mapsev.remoteMe.runUserSub(false, "mapsev","spinrating_itemclick", _position, _value);}
...
Debug.ShouldStop(256);
mapsev.mostCurrent.__c.runVoidMethod ("LogImpl","86553617",RemoteObject.concat(RemoteObject.createImmutable("Searching EV with "),_value,RemoteObject.createImmutable(" rating")),0);
...
try {
		Debug.PushSubsStack("UpdateLocation (mapsev) ","mapsev",8,mapsev.mostCurrent.activityBA,mapsev.mostCurrent,109);
if (RapidSub.canDelegate("updatelocation")) { return b4a.DesaWisataSaribu.mapsev.remoteMe.runUserSub(false, "mapsev","updatelocation");}
...
Debug.ShouldStop(8192);
mapsev.mostCurrent.__c.runVoidMethod ("LogImpl","85963777",RemoteObject.createImmutable("Update user position on Maps Event"),0);
 BA.debugLineNum = 111;BA.debugLine="Log(\"Lat: \"&Starter.lat&\"; Long: \"&Starter.lng)";
Debug.ShouldStop(16384);
mapsev.mostCurrent.__c.runVoidMethod ("LogImpl","85963778",RemoteObject.concat(RemoteObject.createImmutable("Lat: "),mapsev.mostCurrent._starter._lat /*RemoteObject*/ ,RemoteObject.createImmutable("; Long: "),mapsev.mostCurrent._starter._lng /*RemoteObject*/ ),0);
...
try {
		Debug.PushSubsStack("WebViewEV_PageFinished (mapsev) ","mapsev",8,mapsev.mostCurrent.activityBA,mapsev.mostCurrent,205);
if (RapidSub.canDelegate("webviewev_pagefinished")) { return b4a.DesaWisataSaribu.mapsev.remoteMe.runUserSub(false, "mapsev","webviewev_pagefinished", _url);}
...
try {
		Debug.PushSubsStack("WebViewEV_ProgressChanged (mapsev) ","mapsev",8,mapsev.mostCurrent.activityBA,mapsev.mostCurrent,117);
if (RapidSub.canDelegate("webviewev_progresschanged")) { return b4a.DesaWisataSaribu.mapsev.remoteMe.runUserSub(false, "mapsev","webviewev_progresschanged", _loading);}
...
Debug.ShouldStop(4194304);
mapsev.mostCurrent.__c.runVoidMethod ("LogImpl","86029314",RemoteObject.createImmutable("Webview loaded"),0);
...
Debug.ShouldStop(2);
mapsev.mostCurrent.__c.runVoidMethod ("LogImpl","86029325",RemoteObject.concat(RemoteObject.createImmutable("Webview loading at "),_loading,RemoteObject.createImmutable("% ....")),0);
 };
