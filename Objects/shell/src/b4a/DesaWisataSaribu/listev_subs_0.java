...
if (RapidSub.canDelegate("activity_create")) { return b4a.DesaWisataSaribu.listev.remoteMe.runUserSub(false, "listev","activity_create", _firsttime);}
...
listev.mostCurrent._mediamanager.runClassMethod (b4a.DesaWisataSaribu.simplemediamanager.class, "_initialize" /*RemoteObject*/ ,listev.mostCurrent.activityBA);
...
if (RapidSub.canDelegate("activity_pause")) { return b4a.DesaWisataSaribu.listev.remoteMe.runUserSub(false, "listev","activity_pause", _userclosed);}
...
if (RapidSub.canDelegate("activity_resume")) { return b4a.DesaWisataSaribu.listev.remoteMe.runUserSub(false, "listev","activity_resume");}
...
listev.mostCurrent.__c.runVoidMethod ("LogImpl","27864321",RemoteObject.createImmutable("ListEV loaded"),0);
...
if (RapidSub.canDelegate("btnback_click")) { return b4a.DesaWisataSaribu.listev.remoteMe.runUserSub(false, "listev","btnback_click");}
...
Debug.ShouldStop(2);
listev.mostCurrent.__c.runVoidMethod ("LogImpl","27995393",RemoteObject.createImmutable("Going back to previous activity"),0);
...
if (RapidSub.canDelegate("btnrefresh_click")) { return b4a.DesaWisataSaribu.listev.remoteMe.runUserSub(false, "listev","btnrefresh_click");}
 BA.debugLineNum = 144;BA.debugLine="Private Sub btnRefresh_Click";
Debug.ShouldStop(32768);
 BA.debugLineNum = 145;BA.debugLine="Log(\"Refreshing ListEV...\")";
Debug.ShouldStop(65536);
listev.mostCurrent.__c.runVoidMethod ("LogImpl","28323073",RemoteObject.createImmutable("Refreshing ListEV..."),0);
...
if (RapidSub.canDelegate("clv_itemclick")) { return b4a.DesaWisataSaribu.listev.remoteMe.runUserSub(false, "listev","clv_itemclick", _index, _value);}
...
if (RapidSub.canDelegate("createitem")) { return b4a.DesaWisataSaribu.listev.remoteMe.runUserSub(false, "listev","createitem", _id, _category, _name, _date, _img);}
...
if (RapidSub.canDelegate("downloadimg")) { return b4a.DesaWisataSaribu.listev.remoteMe.runUserSub(false, "listev","downloadimg", _imagemap, _readytodownload, _extra);}
int _i = 0;
...
Debug.ShouldStop(67108864);
listev.mostCurrent.__c.runVoidMethod ("LogImpl","28388612",RemoteObject.concat(RemoteObject.createImmutable("Getting "),_imagemap.runMethod(false,"GetValueAt",(Object)(BA.numberCast(int.class, _i))),RemoteObject.createImmutable("@"),_imagemap.runMethod(false,"GetKeyAt",(Object)(BA.numberCast(int.class, _i)))),0);
...
listev.mostCurrent._mediamanager = RemoteObject.createNew ("b4a.DesaWisataSaribu.simplemediamanager");
...
if (RapidSub.canDelegate("jobdone")) { return b4a.DesaWisataSaribu.listev.remoteMe.runUserSub(false, "listev","jobdone", _job);}
...
Debug.ShouldStop(256);
listev.mostCurrent.__c.runVoidMethod ("LogImpl","28257537",RemoteObject.concat(RemoteObject.createImmutable("JobName = "),_job.getField(true,"_jobname" /*RemoteObject*/ ),RemoteObject.createImmutable(", Success = "),_job.getField(true,"_success" /*RemoteObject*/ )),0);
...
Debug.ShouldStop(512);
listev.mostCurrent.__c.runVoidMethod ("LogImpl","28257570",BA.ObjectToString(listev.mostCurrent.__c.runMethod(false,"LastException",listev.mostCurrent.activityBA)),0);
 };
 break; }
}
;
...
if (RapidSub.canDelegate("panellistitem_click")) { return b4a.DesaWisataSaribu.listev.remoteMe.runUserSub(false, "listev","panellistitem_click");}
...
Debug.ShouldStop(1048576);
listev.mostCurrent.__c.runVoidMethod ("LogImpl","28126475",RemoteObject.createImmutable("Redirect to DetailEV Activity"),0);
