...
if (RapidSub.canDelegate("application_error")) { return b4a.DesaWisataSaribu.starter.remoteMe.runUserSub(false, "starter","application_error", _error, _stacktrace);}
...
if (RapidSub.canDelegate("createbitmap")) { return b4a.DesaWisataSaribu.starter.remoteMe.runUserSub(false, "starter","createbitmap");}
...
if (RapidSub.canDelegate("download")) { return b4a.DesaWisataSaribu.starter.remoteMe.runUserSub(false, "starter","download", _imagemap);}
int _i = 0;
...
Debug.ShouldStop(128);
_job.runClassMethod (b4a.DesaWisataSaribu.httpjob.class, "_initialize" /*RemoteObject*/ ,starter.processBA,(Object)(_path),(Object)(starter.getObject()));
 BA.debugLineNum = 73;BA.debugLine="Job.Download(path)";
Debug.ShouldStop(256);
_job.runClassMethod (b4a.DesaWisataSaribu.httpjob.class, "_download" /*RemoteObject*/ ,(Object)(_path));
 }}
;
 }
}Debug.locals.put("i", _i);
...
if (RapidSub.canDelegate("drawroundbitmap")) { return b4a.DesaWisataSaribu.starter.remoteMe.runUserSub(false, "starter","drawroundbitmap", _cvs, _bmp);}
...
if (RapidSub.canDelegate("gps_locationchanged")) { return b4a.DesaWisataSaribu.starter.remoteMe.runUserSub(false, "starter","gps_locationchanged", _location1);}
...
Debug.ShouldStop(2);
starter.mostCurrent.__c.runVoidMethod ("LogImpl","21441799",RemoteObject.createImmutable("Current Location"),0);
 BA.debugLineNum = 131;BA.debugLine="Log(\"Lat = \" & lat)";
Debug.ShouldStop(4);
starter.mostCurrent.__c.runVoidMethod ("LogImpl","21441800",RemoteObject.concat(RemoteObject.createImmutable("Lat = "),starter._lat),0);
 BA.debugLineNum = 132;BA.debugLine="Log(\"Lng = \" & lng)";
Debug.ShouldStop(8);
starter.mostCurrent.__c.runVoidMethod ("LogImpl","21441801",RemoteObject.concat(RemoteObject.createImmutable("Lng = "),starter._lng),0);
...
if (RapidSub.canDelegate("jobdone")) { return b4a.DesaWisataSaribu.starter.remoteMe.runUserSub(false, "starter","jobdone", _job);}
RemoteObject _bmp = RemoteObject.declareNull("anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper");
int _i = 0;
RemoteObject _path = RemoteObject.createImmutable("");
RemoteObject _iv = RemoteObject.declareNull("anywheresoftware.b4a.objects.ImageViewWrapper");
...
_bmp = _job.runClassMethod (b4a.DesaWisataSaribu.httpjob.class, "_getbitmap" /*RemoteObject*/ );Debug.locals.put("bmp", _bmp);Debug.locals.put("bmp", _bmp);
...
Debug.ShouldStop(1073741824);
starter.mostCurrent.__c.runVoidMethod ("LogImpl","21245201",RemoteObject.concat(RemoteObject.createImmutable("Error downloading image: "),_job.getField(true,"_jobname" /*RemoteObject*/ ),starter.mostCurrent.__c.getField(true,"CRLF"),_job.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 };
...
if (RapidSub.canDelegate("service_create")) { return b4a.DesaWisataSaribu.starter.remoteMe.runUserSub(false, "starter","service_create");}
...
if (RapidSub.canDelegate("service_destroy")) { return b4a.DesaWisataSaribu.starter.remoteMe.runUserSub(false, "starter","service_destroy");}
...
if (RapidSub.canDelegate("service_start")) { return b4a.DesaWisataSaribu.starter.remoteMe.runUserSub(false, "starter","service_start", _startingintent);}
...
if (RapidSub.canDelegate("service_taskremoved")) { return b4a.DesaWisataSaribu.starter.remoteMe.runUserSub(false, "starter","service_taskremoved");}
...
if (RapidSub.canDelegate("startgps")) { return b4a.DesaWisataSaribu.starter.remoteMe.runUserSub(false, "starter","startgps");}
...
Debug.ShouldStop(131072);
starter.mostCurrent.__c.runVoidMethod ("LogImpl","21048580",RemoteObject.createImmutable("GPS is started"),0);
 };
...
if (RapidSub.canDelegate("stopgps")) { return b4a.DesaWisataSaribu.starter.remoteMe.runUserSub(false, "starter","stopgps");}
...
Debug.ShouldStop(33554432);
starter.mostCurrent.__c.runVoidMethod ("LogImpl","21114116",RemoteObject.createImmutable("GPS is stopped"),0);
 };
