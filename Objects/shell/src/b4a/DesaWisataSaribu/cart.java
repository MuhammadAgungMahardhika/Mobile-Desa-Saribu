...
public class cart implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("cart"), "b4a.DesaWisataSaribu.cart");
	}
...
public static RemoteObject _userid = RemoteObject.createImmutable("");
public static RemoteObject _btncart = RemoteObject.declareNull("anywheresoftware.b4a.objects.B4XViewWrapper");
...
public static b4a.DesaWisataSaribu.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",cart.mostCurrent._activity,"B4XCollections",Debug.moduleToString(b4a.DesaWisataSaribu.b4xcollections.class),"btnCart",cart.mostCurrent._btncart,"Core",Debug.moduleToString(b4a.DesaWisataSaribu.core.class),"csrfToken",cart.mostCurrent._csrftoken,"DateUtils",cart.mostCurrent._dateutils,"DetailEV",Debug.moduleToString(b4a.DesaWisataSaribu.detailev.class),"DetailRG",Debug.moduleToString(b4a.DesaWisataSaribu.detailrg.class),"Gemma",Debug.moduleToString(b4a.DesaWisataSaribu.gemma.class),"HomeUser",Debug.moduleToString(b4a.DesaWisataSaribu.homeuser.class),"HomeVisitor",Debug.moduleToString(b4a.DesaWisataSaribu.homevisitor.class),"HttpUtils2Service",Debug.moduleToString(b4a.DesaWisataSaribu.httputils2service.class),"ListEv",Debug.moduleToString(b4a.DesaWisataSaribu.listev.class),"ListPackage",Debug.moduleToString(b4a.DesaWisataSaribu.listpackage.class),"ListRG",Debug.moduleToString(b4a.DesaWisataSaribu.listrg.class),"Main",Debug.moduleToString(b4a.DesaWisataSaribu.main.class),"MainScroll",cart.mostCurrent._mainscroll,"manager",cart.mostCurrent._manager,"MapsEV",Debug.moduleToString(b4a.DesaWisataSaribu.mapsev.class),"MapsRG",Debug.moduleToString(b4a.DesaWisataSaribu.mapsrg.class),"MyWebViewExtras",cart.mostCurrent._mywebviewextras,"Navbar",cart.mostCurrent._navbar,"Register",Debug.moduleToString(b4a.DesaWisataSaribu.register.class),"sessionID",cart.mostCurrent._sessionid,"Starter",Debug.moduleToString(b4a.DesaWisataSaribu.starter.class),"TitleNavbar",cart.mostCurrent._titlenavbar,"userId",cart.mostCurrent._userid,"WebViewGemma",cart.mostCurrent._webviewgemma,"XUIViewsUtils",Debug.moduleToString(b4a.DesaWisataSaribu.xuiviewsutils.class)};
}
}