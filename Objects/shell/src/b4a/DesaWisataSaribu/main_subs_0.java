...
try {
		Debug.PushSubsStack("BtnRegister_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,160);
if (RapidSub.canDelegate("btnregister_click")) { return b4a.DesaWisataSaribu.main.remoteMe.runUserSub(false, "main","btnregister_click");}
 BA.debugLineNum = 160;BA.debugLine="Private Sub BtnRegister_Click";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 161;BA.debugLine="Activity.Finish";
Debug.ShouldStop(1);
main.mostCurrent._activity.runVoidMethod ("Finish");
 BA.debugLineNum = 162;BA.debugLine="StartActivity(Register)";
Debug.ShouldStop(2);
...
main.mostCurrent.__c.runVoidMethod ("StartActivity",main.processBA,(Object)((main.mostCurrent._homeuser.getObject())));
 ...
 BA.debugLineNum = 140;BA.debugLine="MsgboxAsync(\"Please input correct credentials\"";
Debug.ShouldStop(2048);
main.mostCurrent.__c.runVoidMethod ("MsgboxAsync",(Object)(BA.ObjectToCharSequence("Please input correct credentials")),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Login Failed"))),main.processBA);
 ...
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",main.processBA, e40.toString()); BA.debugLineNum = 143;BA.debugLine="Log(LastException)";
Debug.ShouldStop(16384);
main.mostCurrent.__c.runVoidMethod ("LogImpl","2524334",BA.ObjectToString(main.mostCurrent.__c.runMethod(false,"LastException",main.mostCurrent.activityBA)),0);
 };
 }else {
 BA.debugLineNum = 146;BA.debugLine="Dim errorParser As JSONParser";
Debug.ShouldStop(131072);
...
Debug.ShouldStop(4194304);
main.mostCurrent.__c.runVoidMethod ("LogImpl","2524342",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_job.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 BA.debugLineNum = 153;BA.debugLine="Dim error As String";
Debug.ShouldStop(16777216);
_error = RemoteObject.createImmutable("");Debug.locals.put("error", _error);
 BA.debugLineNum = 154;BA.debugLine="error = errorMap.Get(\"message\")";
Debug.ShouldStop(33554432);
_error = BA.ObjectToString(_errormap.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("message")))));Debug.locals.put("error", _error);
 BA.debugLineNum = 155;BA.debugLine="ToastMessageShow(\"Error: \" & error, True)";
Debug.ShouldStop(67108864);
