...
main.mostCurrent.__c.runVoidMethod ("LogImpl","8196609",RemoteObject.createImmutable("Login loaded"),0);
 BA.debugLineNum = 62;BA.debugLine="Log(\"Resume: \"&manager.GetBoolean(\"Hanafi\"))";
Debug.ShouldStop(536870912);
main.mostCurrent.__c.runVoidMethod ("LogImpl","8196610",RemoteObject.concat(RemoteObject.createImmutable("Resume: "),main._manager.runMethod(true,"GetBoolean",(Object)(RemoteObject.createImmutable("Hanafi")))),0);
...
Debug.ShouldStop(64);
main.mostCurrent.__c.runVoidMethod ("LogImpl","8327681",RemoteObject.createImmutable("Redirecting to HomeVisitor Activity"),0);
...
Debug.ShouldStop(524288);
main.mostCurrent.__c.runVoidMethod ("LogImpl","8458753",RemoteObject.createImmutable("Checking login status..."),0);
...
main.mostCurrent.__c.runVoidMethod ("LogImpl","8458758",RemoteObject.createImmutable("Redirecting to HomeUser activity"),0);
...
Debug.ShouldStop(1);
main.mostCurrent.__c.runVoidMethod ("LogImpl","8524289",RemoteObject.concat(RemoteObject.createImmutable("JobName = "),_job.getField(true,"_jobname" /*RemoteObject*/ ),RemoteObject.createImmutable(", Success = "),_job.getField(true,"_success" /*RemoteObject*/ )),0);
...
Debug.ShouldStop(128);
main.mostCurrent.__c.runVoidMethod ("LogImpl","8524296",RemoteObject.concat(RemoteObject.createImmutable("Response from server :"),_res),0);
...
Debug.ShouldStop(536870912);
main.mostCurrent.__c.runVoidMethod ("LogImpl","8524318",RemoteObject.createImmutable("Redirect to HomeUser Activity"),0);
...
Debug.ShouldStop(8192);
main.mostCurrent.__c.runVoidMethod ("LogImpl","8524334",BA.ObjectToString(main.mostCurrent.__c.runMethod(false,"LastException",main.mostCurrent.activityBA)),0);
 };
 }else {
...
Debug.ShouldStop(2097152);
main.mostCurrent.__c.runVoidMethod ("LogImpl","8524342",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_job.getField(true,"_errormessage" /*RemoteObject*/ )),0);
