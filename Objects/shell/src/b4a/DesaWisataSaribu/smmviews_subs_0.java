...
public ResumableSub_AddMedia(b4a.DesaWisataSaribu.smmviews parent,RemoteObject __ref,RemoteObject _requestset,RemoteObject _media,RemoteObject _request) {
this.parent = parent;
this.__ref = __ref;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSaribu.smmviews.class, "_cancelrequest" /*RemoteObject*/ ,(Object)(_target));
 BA.debugLineNum = 54;BA.debugLine="Dim ViewType As Int = MediaTypeToViewType(MEDIA.M";
Debug.JustUpdateDeviceLine();
_viewtype = __ref.runClassMethod (b4a.DesaWisataSaribu.smmviews.class, "_mediatypetoviewtype" /*RemoteObject*/ ,(Object)(_media.getField(false,"Meta" /*RemoteObject*/ ).getField(true,"MediaType" /*RemoteObject*/ )),(Object)(_request));Debug.locals.put("ViewType", _viewtype);Debug.locals.put("ViewType", _viewtype);
 BA.debugLineNum = 55;BA.debugLine="Dim sm As SMMView = GetView(ViewType, MEDIA.Meta.";
Debug.JustUpdateDeviceLine();
_sm = __ref.runClassMethod (b4a.DesaWisataSaribu.smmviews.class, "_getview" /*RemoteObject*/ ,(Object)(_viewtype),(Object)(_media.getField(false,"Meta" /*RemoteObject*/ ).getField(true,"Key" /*RemoteObject*/ )));Debug.locals.put("sm", _sm);Debug.locals.put("sm", _sm);
...
Debug.JustUpdateDeviceLine();
_x.runClassMethod (b4a.DesaWisataSaribu.b4ximageview.class, "_setroundedimage" /*RemoteObject*/ ,BA.ObjectToBoolean(_request.getField(false,"Extra" /*RemoteObject*/ ).runMethod(false,"GetDefault",(Object)((__ref.getField(false,"_mmanager" /*RemoteObject*/ ).getField(true,"_request_roundimage" /*RemoteObject*/ ))),(Object)((parent.__c.getField(true,"False"))))));
 BA.debugLineNum = 70;BA.debugLine="x.ResizeMode = Request.Extra.GetDefault(mManage";
Debug.JustUpdateDeviceLine();
_x.runClassMethod (b4a.DesaWisataSaribu.b4ximageview.class, "_setresizemode" /*RemoteObject*/ ,BA.ObjectToString(_request.getField(false,"Extra" /*RemoteObject*/ ).runMethod(false,"GetDefault",(Object)((__ref.getField(false,"_mmanager" /*RemoteObject*/ ).getField(true,"_request_resize_mode" /*RemoteObject*/ ))),(Object)((__ref.getField(false,"_mmanager" /*RemoteObject*/ ).getField(true,"_defaultresizemode" /*RemoteObject*/ ))))));
 BA.debugLineNum = 71;BA.debugLine="x.Bitmap = MediaToBitmap(MEDIA)";
Debug.JustUpdateDeviceLine();
_x.runClassMethod (b4a.DesaWisataSaribu.b4ximageview.class, "_setbitmap" /*RemoteObject*/ ,__ref.runClassMethod (b4a.DesaWisataSaribu.smmviews.class, "_mediatobitmap" /*RemoteObject*/ ,(Object)(_media)));
...
//if
this.state = 16;
if (__ref.getField(false,"_mmanager" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSaribu.simplemediamanager.class, "_iswebpanimated" /*RemoteObject*/ ,(Object)(_media)).<Boolean>get().booleanValue()) { 
this.state = 11;
}if (true) break;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSaribu.smmviews.class, "_parentresized" /*RemoteObject*/ ,(Object)(_target));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.DesaWisataSaribu.smmviews.class, "_returnviewtocache" /*RemoteObject*/ ,(Object)((__ref.getField(false,"_targettosmmviews" /*RemoteObject*/ ).runMethod(false,"Get",(Object)((_target.getObject()))))));
...
smmviews._unusedviews = RemoteObject.createNew ("b4a.DesaWisataSaribu.b4xset");__ref.setField("_unusedviews",smmviews._unusedviews);
...
smmviews._mmanager = RemoteObject.createNew ("b4a.DesaWisataSaribu.simplemediamanager");__ref.setField("_mmanager",smmviews._mmanager);
...
try {
		Debug.PushSubsStack("CreateSMMView (smmviews) ","smmviews",18,__ref.getField(false, "ba"),__ref,350);
...
Debug.JustUpdateDeviceLine();
_t1 = RemoteObject.createNew ("b4a.DesaWisataSaribu.smmviews._smmview");Debug.locals.put("t1", _t1);
...
try {
		Debug.PushSubsStack("GetView (smmviews) ","smmviews",18,__ref.getField(false, "ba"),__ref,230);
...
Debug.JustUpdateDeviceLine();
{
final RemoteObject group1 = __ref.getField(false,"_unusedviews" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSaribu.b4xset.class, "_aslist" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_unusedviews" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSaribu.b4xset.class, "_remove" /*RemoteObject*/ ,(Object)((_sview)));
 BA.debugLineNum = 237;BA.debugLine="Return CreateSMMView(sview.CustomView, sview.mB";
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4a.DesaWisataSaribu.smmviews.class, "_createsmmview" /*RemoteObject*/ ,(Object)(_sview.getField(false,"CustomView" /*RemoteObject*/ )),(Object)(_sview.getField(false,"mBase" /*RemoteObject*/ )),(Object)(_sview.getField(true,"ViewType" /*RemoteObject*/ )),(Object)(_key));
 };
 }
}Debug.locals.put("sview", _sview);
;
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4a.DesaWisataSaribu.smmviews.class, "_createsmmview" /*RemoteObject*/ ,(Object)(_customview),(Object)(_mbase),(Object)(_viewtype),(Object)(_key));
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_unusedviews" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSaribu.b4xset.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"));
...
try {
		Debug.PushSubsStack("MediaToBitmap (smmviews) ","smmviews",18,__ref.getField(false, "ba"),__ref,138);
...
try {
		Debug.PushSubsStack("MediaTypeToViewType (smmviews) ","smmviews",18,__ref.getField(false, "ba"),__ref,167);
...
Debug.JustUpdateDeviceLine();
smmviews.__c.runVoidMethod ("LogImpl","915400978",RemoteObject.concat(RemoteObject.createImmutable("Unexpected media type: "),_mediatype),0);
...
try {
		Debug.PushSubsStack("MimeToMediaType (smmviews) ","smmviews",18,__ref.getField(false, "ba"),__ref,148);
...
smmviews.__c.runVoidMethod ("LogImpl","915335426",RemoteObject.createImmutable("*** Add a reference to B4XGIfView and add SMM_GIF to the build configuration ***"),0);};
...
smmviews.__c.runVoidMethod ("LogImpl","915335429",RemoteObject.createImmutable("*** Add a reference to WebP library and add SMM_WEBP to the build configuration ***"),0);};
...
smmviews.__c.runVoidMethod ("LogImpl","915335434",RemoteObject.createImmutable("*** Add a reference to the video library and add SMM_VIDEO to the build configuration ***"),0);};
...
try {
		Debug.PushSubsStack("ParentResized (smmviews) ","smmviews",18,__ref.getField(false, "ba"),__ref,316);
...
Debug.JustUpdateDeviceLine();
_x.runClassMethod (b4a.DesaWisataSaribu.b4ximageview.class, "_update" /*RemoteObject*/ );
 break; }
case 1: {
 break; }
case 2: {
...
try {
		Debug.PushSubsStack("ReturnViewToCache (smmviews) ","smmviews",18,__ref.getField(false, "ba"),__ref,190);
...
Debug.JustUpdateDeviceLine();
((_sm.getField(false,"CustomView" /*RemoteObject*/ ))).runClassMethod (b4a.DesaWisataSaribu.b4ximageview.class, "_clear" /*RemoteObject*/ );
 break; }
case 1: {
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_unusedviews" /*RemoteObject*/ ).runClassMethod (b4a.DesaWisataSaribu.b4xset.class, "_add" /*RemoteObject*/ ,(Object)((_sm)));
...
try {
		Debug.PushSubsStack("TypeToString (smmviews) ","smmviews",18,__ref.getField(false, "ba"),__ref,299);
