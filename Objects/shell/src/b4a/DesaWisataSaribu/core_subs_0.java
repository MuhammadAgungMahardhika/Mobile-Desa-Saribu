...
try {
		Debug.PushSubsStack("ExecuteUrl (core) ","core",13,_ba,core.mostCurrent,9);
...
_job.runClassMethod (b4a.DesaWisataSaribu.httpjob.class, "_initialize" /*RemoteObject*/ ,BA.rdebugUtils.runMethod(false, "processBAFromBA", _ba),(Object)(_jobname),(Object)(_obj));
 BA.debugLineNum = 12;BA.debugLine="job.PostString(Url, Parameters)";
Debug.ShouldStop(2048);
_job.runClassMethod (b4a.DesaWisataSaribu.httpjob.class, "_poststring" /*RemoteObject*/ ,(Object)(_url),(Object)(_parameters));
...
try {
		Debug.PushSubsStack("ExecuteUrlGet (core) ","core",13,_ba,core.mostCurrent,15);
...
_job.runClassMethod (b4a.DesaWisataSaribu.httpjob.class, "_download" /*RemoteObject*/ ,(Object)(_url));
