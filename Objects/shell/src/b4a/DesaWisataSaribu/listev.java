...
public class listev implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("listev"), "b4a.DesaWisataSaribu.listev");
	}
...
public static b4a.DesaWisataSaribu.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",listev.mostCurrent._activity,"B4XCollections",Debug.moduleToString(b4a.DesaWisataSaribu.b4xcollections.class),"BtnBack",listev.mostCurrent._btnback,"btnRefresh",listev.mostCurrent._btnrefresh,"Cart",Debug.moduleToString(b4a.DesaWisataSaribu.cart.class),"categoryEV",listev.mostCurrent._categoryev,"CLV",listev.mostCurrent._clv,"Core",Debug.moduleToString(b4a.DesaWisataSaribu.core.class),"dateEV",listev.mostCurrent._dateev,"DateUtils",listev.mostCurrent._dateutils,"DetailEV",Debug.moduleToString(b4a.DesaWisataSaribu.detailev.class),"DetailRG",Debug.moduleToString(b4a.DesaWisataSaribu.detailrg.class),"Gemma",Debug.moduleToString(b4a.DesaWisataSaribu.gemma.class),"HomeUser",Debug.moduleToString(b4a.DesaWisataSaribu.homeuser.class),"HomeVisitor",Debug.moduleToString(b4a.DesaWisataSaribu.homevisitor.class),"HttpUtils2Service",Debug.moduleToString(b4a.DesaWisataSaribu.httputils2service.class),"idEV",listev.mostCurrent._idev,"imgMap",listev.mostCurrent._imgmap,"isDownloadReady",listev._isdownloadready,"ivEV",listev.mostCurrent._ivev,"ListPackage",Debug.moduleToString(b4a.DesaWisataSaribu.listpackage.class),"ListRG",Debug.moduleToString(b4a.DesaWisataSaribu.listrg.class),"loadRefresh",listev.mostCurrent._loadrefresh,"Main",Debug.moduleToString(b4a.DesaWisataSaribu.main.class),"MainScroll",listev.mostCurrent._mainscroll,"MapsEV",Debug.moduleToString(b4a.DesaWisataSaribu.mapsev.class),"MapsRG",Debug.moduleToString(b4a.DesaWisataSaribu.mapsrg.class),"MediaManager",listev.mostCurrent._mediamanager,"nameEV",listev.mostCurrent._nameev,"Navbar",listev.mostCurrent._navbar,"PanelList",listev.mostCurrent._panellist,"PanelListItem",listev.mostCurrent._panellistitem,"Register",Debug.moduleToString(b4a.DesaWisataSaribu.register.class),"Starter",Debug.moduleToString(b4a.DesaWisataSaribu.starter.class),"TitleNavbar",listev.mostCurrent._titlenavbar,"xui",listev._xui,"XUIViewsUtils",Debug.moduleToString(b4a.DesaWisataSaribu.xuiviewsutils.class)};
}
}