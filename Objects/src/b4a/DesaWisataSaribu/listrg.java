...
RDebugUtils.currentLine=2097159;
 //BA.debugLineNum = 2097159;BA.debugLine="TitleNavbar.Text = \"List Homestay\"";
...
RDebugUtils.currentLine=2097167;
 //BA.debugLineNum = 2097167;BA.debugLine="Core.ExecuteUrlGet(Main.API&\"homestay\", \"loadHome";
...
anywheresoftware.b4a.keywords.Common.LogImpl("22162689","ListRG loaded",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("22621444","Getting "+BA.ObjectToString(_imagemap.GetValueAt(_i))+"@"+BA.ObjectToString(_imagemap.GetKeyAt(_i)),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("22293761","Going back to previous activity",0);
...
RDebugUtils.currentLine=2752512;
 //BA.debugLineNum = 2752512;BA.debugLine="Private Sub btnCart_Click";
RDebugUtils.currentLine=2752513;
 //BA.debugLineNum = 2752513;BA.debugLine="Log(\"Redirect to Cart Activity\")";
anywheresoftware.b4a.keywords.Common.LogImpl("22752513","Redirect to Cart Activity",0);
RDebugUtils.currentLine=2752514;
 //BA.debugLineNum = 2752514;BA.debugLine="StartActivity(Cart)";
...
anywheresoftware.b4a.keywords.Common.LogImpl("22555905","Refreshing ListRG...",0);
...
RDebugUtils.currentLine=2555908;
 //BA.debugLineNum = 2555908;BA.debugLine="Core.ExecuteUrlGet(Main.API&\"homestay\", \"loadHome";
mostCurrent._core._executeurlget /*String*/ (mostCurrent.activityBA,mostCurrent._main._api /*String*/ +"homestay","loadHomestay",listrg.getObject());
...
anywheresoftware.b4a.keywords.Common.LogImpl("22490369","JobName = "+_job._jobname /*String*/ +", Success = "+BA.ObjectToString(_job._success /*boolean*/ ),0);
...
RDebugUtils.currentLine=2490390;
 //BA.debugLineNum = 2490390;BA.debugLine="CLV.Add(CreateItem(rg.Get(\"id_rumah_gadang\"";
...
anywheresoftware.b4a.keywords.Common.LogImpl("22490403",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
 break; }
}
;
...
RDebugUtils.currentLine=2686984;
 //BA.debugLineNum = 2686984;BA.debugLine="Starter.selectedObj.Put(\"id_rumah_gadang\", a.GetV";
...
anywheresoftware.b4a.keywords.Common.LogImpl("22686987","Redirect to DetailRG Activity",0);
