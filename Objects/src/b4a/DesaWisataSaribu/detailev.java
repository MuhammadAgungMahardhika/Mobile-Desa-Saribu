...
public class detailev extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new anywheresoftware.b4a.ShellBA(this.getApplicationContext(), null, null, "b4a.DesaWisataSaribu", "b4a.DesaWisataSaribu.detailev");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.DesaWisataSaribu", "b4a.DesaWisataSaribu.detailev");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.DesaWisataSaribu.detailev", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
RDebugUtils.currentLine=2555907;
 //BA.debugLineNum = 2555907;BA.debugLine="Activity.LoadLayout(\"MainScrollView\")";
mostCurrent._activity.LoadLayout("MainScrollView",mostCurrent.activityBA);
RDebugUtils.currentLine=2555908;
 //BA.debugLineNum = 2555908;BA.debugLine="MainScroll.Panel.LoadLayout(\"Detail\")";
mostCurrent._mainscroll.getPanel().LoadLayout("Detail",mostCurrent.activityBA);
RDebugUtils.currentLine=2555909;
 //BA.debugLineNum = 2555909;BA.debugLine="wvDetail.Height = MainScroll.Height";
mostCurrent._wvdetail.setHeight(mostCurrent._mainscroll.getHeight());
RDebugUtils.currentLine=2555910;
 //BA.debugLineNum = 2555910;BA.debugLine="MainScroll.Panel.Height = MainScroll.Height";
mostCurrent._mainscroll.getPanel().setHeight(mostCurrent._mainscroll.getHeight());
RDebugUtils.currentLine=2555911;
 //BA.debugLineNum = 2555911;BA.debugLine="TitleNavbar.Text = Starter.selectedObj.Get(\"name\"";
...
RDebugUtils.currentLine=2555913;
 //BA.debugLineNum = 2555913;BA.debugLine="MyWebViewExtras.addWebChromeClient(wvDetail, \"wvD";
...
RDebugUtils.currentLine=2555914;
 //BA.debugLineNum = 2555914;BA.debugLine="wvDetail.JavaScriptEnabled = True";
mostCurrent._wvdetail.setJavaScriptEnabled(anywheresoftware.b4a.keywords.Common.True);
RDebugUtils.currentLine=2555915;
 //BA.debugLineNum = 2555915;BA.debugLine="wvDetail.LoadUrl(Main.server&\"web/event/detail/\"&";
...
RDebugUtils.currentLine=2621441;
 //BA.debugLineNum = 2621441;BA.debugLine="Log(\"DetailEV loaded\")";
anywheresoftware.b4a.keywords.Common.LogImpl("62621441","DetailEV loaded",0);
...
RDebugUtils.currentLine=2752513;
 //BA.debugLineNum = 2752513;BA.debugLine="Log(\"Going back to previous activity\")";
anywheresoftware.b4a.keywords.Common.LogImpl("62752513","Going back to previous activity",0);
