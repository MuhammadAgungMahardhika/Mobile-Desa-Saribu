...
Sub Activity_Create(FirstTime As Boolean)
	...
	TitleNavbar.Text = "Rumah Gadang / Homestay "
	
	MyWebViewExtras.addWebChromeClient(WebViewRG, "WebViewRG")
	WebViewRG.JavaScriptEnabled = True
	WebViewRG.LoadUrl(Main.MobileUri&"rumahGadang/maps")
...
Sub WebViewRG_ReceivedError(ErrorCode As Int, Description As String, FailingUrl As String)
	Log("WebView Error:")
	Log("Error Code: " & ErrorCode)
	Log("Description: " & Description)
	Log("Failing URL: " & FailingUrl)
End Sub
Sub Activity_Resume
	Log("MapsRG Loaded")	
