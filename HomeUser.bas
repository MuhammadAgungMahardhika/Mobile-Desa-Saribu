		...
		Select Job.JobName
			Case "Profile"
				Try
					...
					' Cek apakah first_name dan last_name null atau kosong, lalu tampilkan dengan logika yang tepat
					Dim fullName As String
					If first_name <> Null And first_name <> "" Then fullName = first_name
					If last_name <> Null And last_name <> "" Then fullName = fullName & " " & last_name
					LabelName.Text = fullName.Trim  ' Hapus spasi berlebih jika salah satu nama kosong
